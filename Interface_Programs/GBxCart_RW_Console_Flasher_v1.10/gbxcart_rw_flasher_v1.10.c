...
int main(int argc, char **argv) {
	...
	printf("GBxCart RW Flasher v1.10 by insideGadgets\n");
	printf("########################################\n");
	...
	if (argc >= 2) {
		...
		printf("\nPlease select a Flash Cart:\n"\
					 ...
					 "2. 2 MByte (BV5)\n"\
					 "3. 1 MByte (ES29LV160)\n"\
					 "4. 2 MByte (AM29LV160DB / 29LV160CTTC)\n"\
					 "5. 2 MByte (AM29F016B)\n\n"\
					 "--- Gameboy Advance ---\n"\
					 "6. 16 MByte (MSP55LV128 / 29LV128DTMC)\n"\
					 "7. 16 MByte (MSP55LV128M / 29GL128EHMC / 256M29EWH)\n"\
					 "8. 16 MByte M36L0R706 / 32 MByte 256L30B\n\n"\
					 "x. Exit\n>");
