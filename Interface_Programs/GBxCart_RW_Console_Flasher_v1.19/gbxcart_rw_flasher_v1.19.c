...
int main(int argc, char **argv) {
	...
	printf("GBxCart RW Flasher v1.19 by insideGadgets\n");
	printf("########################################\n");
	...
	if (argc >= 2) {
		...
		if (flashCartType >= 101) {
			...
			printf("4 MByte (M29W640 / 29DL32BF / GL032A10BAIR4) Gameboy Flash Cart\n");
			printf("\nGoing to write to ROM (Flash cart) from %s\n", filenameOnly);
			...
			if (flashCartType == 15) {
				...
				printf("32 MByte (4x 8MB Banks) (M29W256) Gameboy Flash Cart\n");
			}
			printf("\nGoing to write to ROM (Flash cart) from %s\n", filenameOnly);
			...
			printf("insideGadgets 4 MByte 128KB SRAM Gameboy Flash Cart\n");
			printf("\nGoing to write to ROM (Flash cart) from %s\n", filenameOnly);
		...
		// ****** GBA Flash Carts ******
			...
			if (flashCartType == 22) {
				...
				printf("16 MByte M36L0R706 / 32 MByte 256L30B / 4455LLZBQO (2) / 4000L0YBQ0 (2) Gameboy Advance Flash Cart\n");
			}
		...
		printf("\nPlease select a Flash Cart:\n"\
					 ...
					 "1. insideGadgets 32 KByte Flash Cart\n"\
					 "2. insideGadgets 2 MByte 128KB SRAM Flash Cart\n"\
					 "3. insideGadgets 2 MByte 32KB FRAM Flash Cart\n"\
					 "4. insideGadgets 4 MByte 128KB SRAM Flash Cart\n"\
					 "5. insideGadgets 64 MByte 128KB SRAM Mighty Flash Cart\n"\
					 "6. insideGadgets 64 MByte 128KB SRAM Mighty Flash Cart Buffered (Experimental)\n\n"\
					 
					 "--- Gameboy ---\n"\
					 "7. 32 KByte\n"\
					 "8. 512 KByte (SST39SF040)\n"\
					 "9. 1 MByte (ES29LV160)\n"\
					 "10. 2 MByte (BV5)\n"\
					 "11. 2 MByte (AM29LV160DB / 29LV160CTTC / 29LV160TE)\n"\
					 "12. 2 MByte (AM29F016B)\n"\
					 "13. 2 MByte (GB Smart 16M)\n"\
					 "14. 4 MByte (M29W640 / 29DL32BF / GL032A10BAIR4)\n"\
					 "15. 32 MByte (4x 8MB Banks) (256M29)\n"\
					 "16. 32 MByte (4x 8MB Banks) (M29W256)\n\n"\
					 
					 "--- Gameboy Advance ---\n"\
					 "20. 16 MByte (MSP55LV128 / 29LV128DTMC)\n"\
					 "21. 16 MByte (MSP55LV128M / 29GL128EHMC / 256M29EWH / MX29GL128ELT / M29W128 / S29GL128)\n"\
					 "22. 16 MByte M36L0R706 / 32 MByte 256L30B / 4455LLZBQO / 4000L0YBQ0\n"\
					 "23. 16 MByte M36L0R706 / 32 MByte 256L30B / 4455LLZBQO (2) / 4000L0YBQ0 (2)\n"\
