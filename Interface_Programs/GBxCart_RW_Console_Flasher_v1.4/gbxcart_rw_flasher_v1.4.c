...
int main(int argc, char **argv) {
	...
	printf("GBxCart RW Flasher v1.4 by insideGadgets\n");
	printf("########################################\n");
	...
	if (argc >= 2) {
		...
		printf("\nPlease select a Flash Cart:\n"\
					 ...
					 "--- Gameboy Advance ---\n"\
					 "3. 16 MByte (MSP55LV128) Gameboy Advance Flash Cart\n"\
					 "4. 16 MByte (MSP55LV128M / 29GL128EHMC) Gameboy Advance Flash Cart\n"\
					 "x. Exit\n>");
