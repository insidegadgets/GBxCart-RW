...
uint8_t flashCartList[] = { 1, 29, 30, 31, 2, 42, 3, 4, 35, 5, 6, // GB iG carts (Array 1-10)
									  0, 8, 32, 9, 33, 10, 11, 12, 34, 13, 14, 15, 39, 40, 38, 16, 17,  // GB carts (Array 10-19)
									  20, 27, 41, 43, 21, 22, 23, 24, 25, 26, 36, 37}; // GBA carts (Array 20-26)
