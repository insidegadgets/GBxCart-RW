            ...
            while (true) {
                ...
                if (commandReceived == READROM) { // Read ROM
                    ...
                    if (chipEraseSelected == 1) {
                        if (writeRomCartType == 2 || writeRomCartType == 4 || writeRomCartType == 5 || writeRomCartType == 6 || writeRomCartType == 7 || writeRomCartType == 8 || writeRomCartType == 9 || writeRomCartType == 10) {
                    ...
                    if (cancelOperation == 0) {
                        ...
                        if (formMinimised == true) {
                            notifyIcon1.BalloonTipIcon = ToolTipIcon.Info;
                            notifyIcon1.BalloonTipText = "Erasing RAM Finished";
                            notifyIcon1.BalloonTipTitle = "GBxCart RW";
                            notifyIcon1.ShowBalloonTip(4000);
                        }
                    }
