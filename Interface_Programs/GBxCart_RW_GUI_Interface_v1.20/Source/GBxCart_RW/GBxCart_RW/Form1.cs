    ...
    partial class Form1 : Form
    {
        ...
        void backgroundWorker2_DoWork(object sender, DoWorkEventArgs e) {
            while (true) {
                ...
                if (commandReceived == READROM) { // Read ROM
                    ...
                    // First erase the flash chip if needed if selected
                    if (chipEraseSelected == 1) {
                        if (writeRomCartType == 2 || writeRomCartType == 4 || writeRomCartType == 5 || writeRomCartType == 6 || writeRomCartType == 7 || writeRomCartType == 8) {
        ...
        private void writerombutton_Click(object sender, EventArgs e) {
            if (comConnected == true && writeRomSelected == true && commandReceived == 0) {
                ...
                int writingROM = 1;
                if (writeRomCartType == 4 || writeRomCartType == 5) {
                ...
                if (writingROM == 1) {
                    ...
                    if (writeRomCartType == 100 || writeRomCartType == 101 || writeRomCartType == 102 || chipEraseSelected == 0) {
                        statuslabel.Text = "Writing ROM...";
                    }
                    else {
